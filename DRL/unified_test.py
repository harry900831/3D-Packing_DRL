...
def unified_test(url, config):
    ...
    env = gym.make(config.env_name, _adjust_ratio=0, adjust=False,
                    ...
                    fix_box_list=np.load('box_list.npy').tolist(),
    ...
    #         print('case', i+1)
    env.reset()
    box_list = env.box_creator.preview(26)
    print(box_list)
