...
from .binCreator import RandomBoxCreator, LoadBoxCreator, BoxCreator, FixBoxCreator
...
class PackingGame(gym.Env):
    def __init__(self, box_creator=None, container_size = (20, 20, 20),
                 ...
                 data_type = 'depen', enable_rotation=False, fix_box_list=None, **kwags):
        ...
        if test:
            ...
            self.box_creator = FixBoxCreator(fix_box_list)
